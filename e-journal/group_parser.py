        ...
        for num in range(1, len(day)):
            ...
            if p_group[num] != '':
                ...
                cursor.execute(""" 
                    INSERT INTO bad_parse (bad_faculty, bad_course, bad_group, bad_week, bad_day, bad_lesson, bad_subject, bad_teacher, bad_aud, bad_subj_type, bad_p_group)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NULL)
                """, (fak, kurs, grup, week[num], day[num], lesson[num], subject[num], teacher[num], aud[num], subj_type[num]))
                connection.commit()
        
        cursor.execute(
            f"DELETE FROM parse_schedule WHERE trim(full_group) LIKE '{grup}'"
        )
        connection.commit()
...
def check():
    ...
    if fak.strip().lower() == 'гф':
        ...
        fak = 'ГФ'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-ГФ-АКС-1асп, 2022-ГФ-Г-1асп, 2022-ГФ-ГиДЗакс-1б, 2022-ГФ-ГиДЗакс-1м, 2022-ГФ-ГиДЗг-1б, 2022-ГФ-ГиДЗг-1м, 2022-ГФ-ГиДЗипр-1б, \
                                               2022-ГФ-ГиДЗкгин-1б, 2022-ГФ-ПГинж.г-1с, 2022-ГФ-ПГинж.г-2с, 2022-ГФ-ПГинж.г-3с, 2022-ГФ-ПГинж.г-4с, 2022-ГФ-ПГинж.г-5с)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-ГФ-АКС-1асп(зо), 2021-ГФ-АКС-1асп(оч), 2021-ГФ-Г-1асп(зо), 2021-ГФ-Г-1асп(оч), 2021-ГФ-ГиДЗакс-1б, 2021-ГФ-ГиДЗакс-1м, \
            ...
            grup = str(input('Введите группу (2020-ГФ-ГиДЗакс-1б, 2020-ГФ-ГиДЗг-1б, 2020-ГФ-ГиДЗипр-1б, 2020-ГФ-ГиДЗкгин-1б, 2020-ГФ-ПГинж.г-1с, 2020-ГФ-ПГинж.г-2с, \
                                               2020-ГФ-ПГинж.г-3с, 2020-ГФ-ПГинж.г-4с, 2020-ГФ-ПГинж.г-5с)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-ГФ-ГиДЗакс-1б, 2019-ГФ-ГиДЗг-1б, 2019-ГФ-ГиДЗипр-1б, 2019-ГФ-ГиДЗкгин-1б, 2019-ГФ-ПГинж.г-1с, \
                                               2019-ГФ-ПГинж.г-2с, 2019-ГФ-ПГинж.г-3с, 2019-ГФ-ПГинж.г-4с, 2019-ГФ-ПГинж.г-5с)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '5':
            grup = str(input('Введите группу (2018-ГФ-ПГинж.г-1с, 2018-ГФ-ПГинж.г-2с, 2018-ГФ-ПГинж.г-3с)): '))
            return fak, kurs, grup
        else:
            print('Неверный ввод')
        ...
        fak = 'КФ'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-КФ-ГК-1асп, 2022-КФ-КиГ-1б, 2022-КФ-КиГ-1м, 2022-КФ-КиГ-2б, 2022-КФ-КиГ-2м, 2022-КФ-КиГ-3б, 2022-КФ-КиГ-4б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-КФ-К-1асп, 2021-КФ-КиГ-1б, 2021-КФ-КиГ-1м, 2021-КФ-КиГ-2б, 2021-КФ-КиГ-3б, 2021-КФ-КиГ-4б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '3':
            grup = str(input('Введите группу (2020-КФ-КиГ-1б, 2020-КФ-КиГ-2б, 2020-КФ-КиГ-3б, 2020-КФ-КиГ-4б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-КФ-КиГ-1б, 2019-КФ-КиГ-2б, 2019-КФ-КиГ-3б, 2019-КФ-КиГ-4б)): '))
            return fak, kurs, grup
        else:
            print('Неверный ввод')
        ...
        fak = 'ФАГ'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-ФАиГ-АРХ-1б, 2022-ФАиГ-АРХ-1м, 2022-ФАиГ-АРХ-2м, 2022-ФАиГ-Градо-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-ФАиГ-АРХ-1б, 2021-ФАиГ-АРХ-1м, 2021-ФАиГ-Градо-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '3':
            grup = str(input('Введите группу (2020-ФАиГ-АРХ-1б, 2020-ФАиГ-АРХ-2б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-ФАиГ-АРХ-1б, 2019-ФАиГ-АРХ-2б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '5':
            grup = str(input('Введите группу (2018-ФАиГ-АРХ-1б, 2018-ФАиГ-АРХ-2б)): '))        
            return fak, kurs, grup
        else:
            print('Неверный ввод')
        ...
        fak = 'ФОП'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-ФОП-ЛТиЛТ-1б, 2022-ФОП-ОПТ-1б, 2022-ФОП-ОПТ-1м, 2022-ФОП-ОПТ-2м, 2022-ФОП-ОЭП-1асп, 2022-ФОП-ЭиОЭПиССН-1)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-ФОП-ЛТиЛТ-1б, 2021-ФОП-ОПТ-1б, 2021-ФОП-ОПТ-1м, 2021-ФОП-ОЭПиС-1асп, 2021-ФОП-ЭиОЭПиССН-1)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '3':
            grup = str(input('Введите группу (2020-ФОП-ЛТиЛТ-1б, 2020-ФОП-ОПТ-1б, 2020-ФОП-ЭиОЭПиССН-1)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-ФОП-ЛТиЛТ-1б, 2019-ФОП-ОПТ-1б, 2019-ФОП-ЭиОЭПиССН-1)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '5':
            grup = str(input('Введите группу (2018-ФОП-ЭиОЭПиССН-1)): '))
            return fak, kurs, grup
        else:
            print('Неверный ввод')
        ...
        fak = 'ФУТ'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-ФУТ-ЗиКзио-1б, 2022-ФУТ-ЗиКзио-1м, 2022-ФУТ-ЗиКкн-1б, 2022-ФУТ-ЗиКунирт-1м, 2022-ФУТ-ЗиКупр-1б, 2022-ФУТ-ЗКиМЗ-1асп, 2022-ФУТ-САиУ-1б, 2022-ФУТ-УК-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-ФУТ-ЗиКзио-1б, 2021-ФУТ-ЗиКзио-1м, 2021-ФУТ-ЗиКкн-1б, 2021-ФУТ-ЗиКунирт-1м, 2021-ФУТ-ЗиКупр-1б, 2021-ФУТ-ЗК-1асп (зо, 2021-ФУТ-ЗК-1асп (оч)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '3':
            grup = str(input('Введите группу (2020-ФУТ-ЗиКзио-1б, 2020-ФУТ-ЗиКкн-1б, 2020-ФУТ-ЗиКупр-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-ФУТ-ЗиКзио-1б, 2019-ФУТ-ЗиКкн-1б, 2019-ФУТ-ЗиКупр-1б)): '))
            return fak, kurs, grup
        else:
            print('Неверный ввод')
        ...
        fak = 'ФГиИБ'
        if str(kurs).strip() == '1':
            grup = str(input('Введите группу (2022-ФГиИБ-ИБ-1б, 2022-ФГиИБ-ИБ-1м, 2022-ФГиИБ-ИБ-2б, 2022-ФГиИБ-ИСиТ-1б, 2022-ФГиИБ-ИСиТ-2б, 2022-ФГиИБ-ИСиТ-3б, \
                               2022-ФГиИБ-ИСиТиб ик, 2022-ФГиИБ-ПИ-1б, 2022-ФГиИБ-ПИ-2б, 2022-ФГиИБ-ПИабпд-1м)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '2':
            grup = str(input('Введите группу (2021-ФГиИБ-Геоинф-1а, 2021-ФГиИБ-ИБ-1б, 2021-ФГиИБ-ИБ-2б, 2021-ФГиИБ-ИСиТ-1б, 2021-ФГиИБ-ИСиТ-2б, \
                                               2021-ФГиИБ-ИСиТгсит-, 2021-ФГиИБ-ИСиТиб ик, 2021-ФГиИБ-ПИ-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '3':
            grup = str(input('Введите группу (2020-ФГиИБ-ИБ-1б, 2020-ФГиИБ-ИБ-2б, 2020-ФГиИБ-ИСиТ-1б, 2020-ФГиИБ-ИСиТ-2б, 2020-ФГиИБ-ПИ-1б)): '))
            return fak, kurs, grup
        elif str(kurs).strip() == '4':
            grup = str(input('Введите группу (2019-ФГиИБ-ИБ-1б, 2019-ФГиИБ-ИБ-2б, 2019-ФГиИБ-ИСиТ-1б, 2019-ФГиИБ-ИСиТ-2б, 2019-ФГиИБ-ПИ-1б)): '))
            return fak, kurs, grup
        else:
            print('Неверный ввод')
    else:
